          ...
          <div className="bg-content1 rounded-lg p-6 sm:p-8 border border-default-200 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 sm:py-3.5 bg-background border border-default-300 rounded-lg text-foreground font-medium text-sm sm:text-base hover:bg-default-100 transition-colors duration-200"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
